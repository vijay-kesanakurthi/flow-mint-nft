...
fcl.config({
  ...
  "app.detail.title": "Dino", // Change the title!
    ...
    try {
      const transactionId = await fcl.mutate({
        ...
        args: (arg, t) => [
          ...
          arg("Dino # "+_id.toString(), types.String),
          arg("Dino Collection", types.String),
          arg("https://bafybeidzhuz4w4gb2x5vk4rdfwuh2cavjsh5t237gtdjpdfs4w2eknfpaq.ipfs.nftstorage.link/"+_id+".png", types.String),
        ],
